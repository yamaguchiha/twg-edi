...
import static jp.or.twg.twg_edi.common.mapper.OptionShipmentDynamicSqlSupport.*;
...
@Mapper
public interface OptionShipmentMapper {

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	BasicColumn[] selectList = BasicColumn.columnList(oid, placeStOid, tableNo, memo, tsRegistererDate,
	...
	int insert(InsertStatementProvider<OptionShipment> insertStatement);

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	@InsertProvider(type = SqlProviderAdapter.class, method = "insertMultiple")
	int insertMultiple(MultiRowInsertStatementProvider<OptionShipment> multipleInsertStatement);

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	@SelectProvider(type = SqlProviderAdapter.class, method = "select")
	@ResultMap("OptionShipmentResult")
	Optional<OptionShipment> selectOne(SelectStatementProvider selectStatement);

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	@SelectProvider(type = SqlProviderAdapter.class, method = "select")
	@Results(id = "OptionShipmentResult", value = {
			@Result(column = "oid", property = "oid", jdbcType = JdbcType.BIGINT, id = true),
			@Result(column = "place_st_oid", property = "placeStOid", jdbcType = JdbcType.BIGINT),
			@Result(column = "table_no", property = "tableNo", jdbcType = JdbcType.INTEGER),
	...
	List<OptionShipment> selectMany(SelectStatementProvider selectStatement);
	...
	default long count(CountDSLCompleter completer) {
		return MyBatis3Utils.countFrom(this::count, optionShipment, completer);
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	default int delete(DeleteDSLCompleter completer) {
		return MyBatis3Utils.deleteFrom(this::delete, optionShipment, completer);
	}
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	default int insert(OptionShipment record) {
		return MyBatis3Utils.insert(this::insert, record, optionShipment,
				c -> c.map(oid).toProperty("oid").map(placeStOid).toProperty("placeStOid").map(tableNo)
						.toProperty("tableNo").map(memo).toProperty("memo").map(tsRegistererDate)
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	default int insertMultiple(Collection<OptionShipment> records) {
		return MyBatis3Utils.insertMultiple(this::insertMultiple, records, optionShipment,
				c -> c.map(oid).toProperty("oid").map(placeStOid).toProperty("placeStOid").map(tableNo)
						.toProperty("tableNo").map(memo).toProperty("memo").map(tsRegistererDate)
						.toProperty("tsRegistererDate").map(tsRegistererUserId).toProperty("tsRegistererUserId")
						.map(tsRegistererUserPlaceId).toProperty("tsRegistererUserPlaceId").map(tsLastModifiedDate)
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	default int insertSelective(OptionShipment record) {
		return MyBatis3Utils.insert(this::insert, record, optionShipment, c -> c.map(oid)
				.toPropertyWhenPresent("oid", record::getOid).map(placeStOid)
				.toPropertyWhenPresent("placeStOid", record::getPlaceStOid).map(tableNo)
				.toPropertyWhenPresent("tableNo", record::getTableNo).map(memo)
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	default Optional<OptionShipment> selectOne(SelectDSLCompleter completer) {
		return MyBatis3Utils.selectOne(this::selectOne, selectList, optionShipment, completer);
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	default List<OptionShipment> select(SelectDSLCompleter completer) {
		return MyBatis3Utils.selectList(this::selectMany, selectList, optionShipment, completer);
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	default List<OptionShipment> selectDistinct(SelectDSLCompleter completer) {
		return MyBatis3Utils.selectDistinct(this::selectMany, selectList, optionShipment, completer);
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	default Optional<OptionShipment> selectByPrimaryKey(Long oid_) {
		return selectOne(c -> c.where(oid, isEqualTo(oid_)));
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	default int update(UpdateDSLCompleter completer) {
		return MyBatis3Utils.update(this::update, optionShipment, completer);
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	static UpdateDSL<UpdateModel> updateAllColumns(OptionShipment record, UpdateDSL<UpdateModel> dsl) {
		return dsl.set(oid).equalTo(record::getOid).set(placeStOid).equalTo(record::getPlaceStOid).set(tableNo)
				.equalTo(record::getTableNo).set(memo).equalTo(record::getMemo).set(tsRegistererDate)
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	static UpdateDSL<UpdateModel> updateSelectiveColumns(OptionShipment record, UpdateDSL<UpdateModel> dsl) {
		return dsl.set(oid).equalToWhenPresent(record::getOid).set(placeStOid).equalToWhenPresent(record::getPlaceStOid)
				.set(tableNo).equalToWhenPresent(record::getTableNo).set(memo).equalToWhenPresent(record::getMemo)
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	default int updateByPrimaryKey(OptionShipment record) {
		return update(c -> c.set(placeStOid).equalTo(record::getPlaceStOid).set(tableNo).equalTo(record::getTableNo)
				.set(memo).equalTo(record::getMemo).set(tsRegistererDate).equalTo(record::getTsRegistererDate)
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.4973066+09:00", comments = "Source Table: public.option_shipment")
	default int updateByPrimaryKeySelective(OptionShipment record) {
		return update(c -> c.set(placeStOid).equalToWhenPresent(record::getPlaceStOid).set(tableNo)
				.equalToWhenPresent(record::getTableNo).set(memo).equalToWhenPresent(record::getMemo)
				.set(tsRegistererDate).equalToWhenPresent(record::getTsRegistererDate).set(tsRegistererUserId)
				.equalToWhenPresent(record::getTsRegistererUserId).set(tsRegistererUserPlaceId)
				.equalToWhenPresent(record::getTsRegistererUserPlaceId).set(tsLastModifiedDate)
				.equalToWhenPresent(record::getTsLastModifiedDate).set(tsLastModifiedUserId)
