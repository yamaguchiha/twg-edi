...
import static jp.or.twg.twg_edi.common.mapper.OptionSystemConfigDynamicSqlSupport.*;
...
import jp.or.twg.twg_edi.common.entity.OptionSystemConfig;
...
@Mapper
public interface OptionSystemConfigMapper {
	...
	BasicColumn[] selectList = BasicColumn.columnList(oid, ownPlaceOid, category, parameter, memo, tsRegistererDate,
	...
	int insert(InsertStatementProvider<OptionSystemConfig> insertStatement);

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	@InsertProvider(type = SqlProviderAdapter.class, method = "insertMultiple")
	int insertMultiple(MultiRowInsertStatementProvider<OptionSystemConfig> multipleInsertStatement);

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	@SelectProvider(type = SqlProviderAdapter.class, method = "select")
	@ResultMap("OptionSystemConfigResult")
	Optional<OptionSystemConfig> selectOne(SelectStatementProvider selectStatement);

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	@SelectProvider(type = SqlProviderAdapter.class, method = "select")
	@Results(id = "OptionSystemConfigResult", value = {
	...
	List<OptionSystemConfig> selectMany(SelectStatementProvider selectStatement);
	...
	default long count(CountDSLCompleter completer) {
		return MyBatis3Utils.countFrom(this::count, optionSystemConfig, completer);
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	default int delete(DeleteDSLCompleter completer) {
		return MyBatis3Utils.deleteFrom(this::delete, optionSystemConfig, completer);
	}
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	default int insert(OptionSystemConfig record) {
		return MyBatis3Utils.insert(this::insert, record, optionSystemConfig,
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	default int insertMultiple(Collection<OptionSystemConfig> records) {
		return MyBatis3Utils.insertMultiple(this::insertMultiple, records, optionSystemConfig,
				c -> c.map(oid).toProperty("oid").map(ownPlaceOid).toProperty("ownPlaceOid").map(category)
						.toProperty("category").map(parameter).toProperty("parameter").map(memo).toProperty("memo")
						.map(tsRegistererDate).toProperty("tsRegistererDate").map(tsRegistererUserId)
						.toProperty("tsRegistererUserId").map(tsRegistererUserPlaceId)
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	default int insertSelective(OptionSystemConfig record) {
		return MyBatis3Utils.insert(this::insert, record, optionSystemConfig, c -> c.map(oid)
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	default Optional<OptionSystemConfig> selectOne(SelectDSLCompleter completer) {
		return MyBatis3Utils.selectOne(this::selectOne, selectList, optionSystemConfig, completer);
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	default List<OptionSystemConfig> select(SelectDSLCompleter completer) {
		return MyBatis3Utils.selectList(this::selectMany, selectList, optionSystemConfig, completer);
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	default List<OptionSystemConfig> selectDistinct(SelectDSLCompleter completer) {
		return MyBatis3Utils.selectDistinct(this::selectMany, selectList, optionSystemConfig, completer);
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	default Optional<OptionSystemConfig> selectByPrimaryKey(Long oid_) {
		return selectOne(c -> c.where(oid, isEqualTo(oid_)));
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	default int update(UpdateDSLCompleter completer) {
		return MyBatis3Utils.update(this::update, optionSystemConfig, completer);
	}

	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	static UpdateDSL<UpdateModel> updateAllColumns(OptionSystemConfig record, UpdateDSL<UpdateModel> dsl) {
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	static UpdateDSL<UpdateModel> updateSelectiveColumns(OptionSystemConfig record, UpdateDSL<UpdateModel> dsl) {
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	default int updateByPrimaryKey(OptionSystemConfig record) {
		return update(c -> c.set(ownPlaceOid).equalTo(record::getOwnPlaceOid).set(category).equalTo(record::getCategory)
				.set(parameter).equalTo(record::getParameter).set(memo).equalTo(record::getMemo).set(tsRegistererDate)
	...
	@Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2022-06-21T19:20:40.5182516+09:00", comments = "Source Table: public.option_system_config")
	default int updateByPrimaryKeySelective(OptionSystemConfig record) {
		return update(c -> c.set(ownPlaceOid).equalToWhenPresent(record::getOwnPlaceOid).set(category)
				...
				.set(memo).equalToWhenPresent(record::getMemo).set(tsRegistererDate)
