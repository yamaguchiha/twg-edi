...
//            write it like this;
//
//                  <<event>>="wrtCalendarLay(<<element>>,event);"
//
//            e.g. onClick="wrtCalendarLay(scwID('myElement'),event);"
//            or   onMouseOver="wrtCalendarLay(this,event);"
//
//            NOTE: If you wish to use the calendar with an Anchor tag, do
//                  not use the syntax:   href="javascript:wrtCalendarLay(...)"
//                  Instead you should use the following;
//
//                  <a href="#" onclick="wrtCalendarLay(<<element>>,event);return false;">
//                      <<your text>>
//                  </a>
//
...
//            node;
//
//            e.g.  <p onclick="wrtCalendarLay(this,event);"><<date>></p>
//
//            You can also disable days of the week by adding arguments to the
//            call to wrtCalendarLay.  The values should be Sunday = 0 through to
//            Saturday = 6.  A call to wrtCalendarLay with Friday and Monday disabled
//            would look something like this;
//
//                  wrtCalendarLay(<<element>>,event,5,1);
//
//            Finally you can use the following technique to run a function
//            when the calendar closes:
//
//                  scwNextAction=<<function>>.runsAfterSCW(this,<<arguments>>);
//                  wrtCalendarLay(<<element>>,event <<,optional arguments above>>);
//
...
//
//            E.G.  wrtCalendarLay(<<target element>>,<<source element>>);
//                  as in: wrtCalendarLay(this,this);
//
//            ------------------------------------------------------------------
...
//                <body>
//                    <script type='text/JavaScript' src='scw.js'></script>
//                    <p onclick='wrtCalendarLay(this,event);'>06-Dec-2006</p>
//                    <input onclick='wrtCalendarLay(this,event);' value='07-Dec-2006' />
//                    <br/><br/>
//                    <a href='#' onclick='wrtCalendarLay(this,event);return false;'>
//                        08-Dec-2006
//                    </a>
//                </body>
//            </html>
...
//******************************************************************************
        ...
        {try
            ...
            {// English
             ...
             scwArrMonthNames       = ['01','02','03','04','05','06',
                                       '07','08','09','10','11','12'];
             scwArrWeekInits        = ["日","月","火","水","木","金","土"];
             scwInvalidDateMsg      = '入力した日付は不正です。YYYY/MM/DDで入力して下さい。\n';
             scwOutOfRangeMsg       = '入力した日付は範囲外です。';
             scwDoesNotExistMsg     = '入力した日付は存在しません。';
             scwInvalidAlert        = ['不正な日付 (',') '];
    ...
    var wrtCalendarLayInvalidDateMsg       = true,
        wrtCalendarLayOutOfRangeMsg        = true,
        wrtCalendarLayDoesNotExistMsg      = true,
        wrtCalendarLayInvalidAlert         = true,
        wrtCalendarLayDateDisablingError   = true,
        wrtCalendarLayRangeDisablingError  = true;
...
//    var scwDateOutputFormat  = 'DD MMM YYYY'; // e.g. 'MMM-DD-YYYY' for the US
    ...
    // wrtCalendarLay. The syntax is described at the top of this script in
    // the section:
    //    "How to use the Calendar once it is defined for your page:"
    //
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #dcdcdc;}'  +
            '/* Drag Handle */'                                         +
            ...
            '/* Week day headings */'                                   +
            'td.scwWeek                 {background-color:  #666666;'   +
                                        'color:             #EEEEEE;}'  +
            '/* Week numbers */'                                        +
...
//  Variables required by both wrtCalendarLay and wrtCalendarLayMonth
...
//  Exposed functions:
//
//      wrtCalendarLay             Entry point for display of calendar,
//                              called in main page.
//      showCal             Legacy name of wrtCalendarLay:
//                              Passes only legacy arguments,
//                              not the optional day disabling arguments.
//
//      wrtCalendarLayMonth        Displays a month on the calendar,
...
// ****************************************************************************
    ...
    function showCal(scwEle,scwSource) {wrtCalendarLay(scwEle,scwSource);};
    function wrtCalendarLay(scwEle,scwSource)
        {if (!scwSource) {scwSource = window.event;}
            ...
            {function scwInputFormat()
                {var scwArrSeed = new Array(),
                 ...
                 if (scwExpValYear.exec(scwArrSeed[0])  == null ||
                    ...
                    {if (wrtCalendarLayInvalidDateMsg)
         ...
         if (isNaN(scwSeedDate))
            {if (wrtCalendarLayInvalidDateMsg) {alert(scwInvalidDateMsg + scwInvalidAlert[0] + scwDateValue + scwInvalidAlert[1]);}
             scwSeedDate = new Date(scwBaseYear + Math.floor(scwDropDownYears/2),5,1);
             scwBlnFullInputDate=false;
            }
         else
            {// Test that the date is within range,
             ...
             if ((new Date(scwBaseYear,0,1)) > scwSeedDate)
                {if (scwBlnStrict && wrtCalendarLayOutOfRangeMsg) {alert(scwOutOfRangeMsg);}
                ...
                {if ((new Date(scwBaseYear+scwDropDownYears,0,0))<scwSeedDate)
                    ...
                    {if (scwBlnStrict && scwBlnFullInputDate &&
                        ...
                        {if (wrtCalendarLayDoesNotExistMsg) alert(scwDoesNotExistMsg);
                ...
                {if ((typeof scwDisabledDates[i] == 'object') && (scwDisabledDates[i].constructor == Array))
                    {var scwPass = true;
                     ...
                     if (scwDisabledDates[i].length !=2)
                        {if (wrtCalendarLayRangeDisablingError)
                    ...
                    {if (wrtCalendarLayRangeDisablingError) {alert(scwDateDisablingError[0] + scwDisabledDates[i] + scwDateDisablingError[1]);}}
                }
            }
    ...
    function wrtCalendarLayMonth(scwBias)
        {// Set the selectable Month and Year
         ...
         var wrtCalendarLayDate  = new Date(Date.parse(new Date().toDateString())),
         ...
         wrtCalendarLayDate.setHours(12);
         ...
         wrtCalendarLayDate.setFullYear(scwBaseYear + Math.floor(scwMonthSum/12),(scwMonthSum%12),1);
         ...
         scwTemp = (12*parseInt((wrtCalendarLayDate.getFullYear()-scwBaseYear),10)) + parseInt(wrtCalendarLayDate.getMonth(),10);

         if (scwTemp > -1 && scwTemp < (12*scwDropDownYears))
            {scwSelYears.options.selectedIndex=Math.floor(scwMonthSum/12);
             scwSelMonths.options.selectedIndex=(scwMonthSum%12);

             scwCurMonth = wrtCalendarLayDate.getMonth();

             wrtCalendarLayDate.setDate((((wrtCalendarLayDate.
                                    getDay()-scwWeekStart)<0)?-6:1)+
                                 scwWeekStart-wrtCalendarLayDate.getDay());

             // This statement moved by Michael Cerveny to make version 3.55
             var scwCompareDateValue = new Date(wrtCalendarLayDate.getFullYear(),
                                                wrtCalendarLayDate.getMonth(),
                                                wrtCalendarLayDate.getDate()).valueOf();

             scwStartDate = new Date(wrtCalendarLayDate);
                ...
                {var scwRows = scwCells.childNodes[i];
                 if (scwRows.nodeType==1 && scwRows.tagName=='TR')
                    {if (scwWeekNumberDisplay)
                        {//Calculate the week number using wrtCalendarLayDate
                         scwTmpEl = scwRows.childNodes[0];
                         scwTmpEl.innerHTML = scwWeekNumber(wrtCalendarLayDate);
                        ...
                        {var scwCols = scwRows.childNodes[j];
                         if (scwCols.nodeType==1 && scwCols.tagName=='TD')
                            {scwRows.childNodes[j].innerHTML=
                                wrtCalendarLayDate.getDate();
                             var scwCell=scwRows.childNodes[j],
                                 scwDisabled =
                                    ((scwOutOfRangeDisable &&
                                        (wrtCalendarLayDate <
                                            (new Date(scwBaseYear,0,1,
                                                      wrtCalendarLayDate.getHours()))
                                         ||
                                         wrtCalendarLayDate >
                                     ...
                                     (scwOutOfMonthDisable &&
                                        (wrtCalendarLayDate <
                                            (new Date(wrtCalendarLayDate.getFullYear(),
                                                      scwCurMonth,1,
                                                      wrtCalendarLayDate.getHours()))
                                         ||
                                         wrtCalendarLayDate >
                             ...
                             if (scwDisabled ||
                                ...
                                {scwRows.childNodes[j].onclick = null;
                                 ...
                                 scwCell.className=
                                    (wrtCalendarLayDate.getMonth()!=scwCurMonth)
                                        ?'scwCellsExMonthDisabled'
                                        :(scwBlnFullInputDate &&
                                          wrtCalendarLayDate.toDateString()==
                                          scwSeedDate.toDateString())
                                            ?'scwInputDateDisabled'
                                            :(wrtCalendarLayDate.getDay()%6==0)
                                                ?'scwCellsWeekendDisabled'
                                                :'scwCellsDisabled';

                                 scwCell.style.borderColor =
                                     (scwFormatTodayCell && wrtCalendarLayDate.toDateString()==scwDateNow.toDateString())
                             ...
                             wrtCalendarLayDate.setDate(wrtCalendarLayDate.getDate()+1);
                             scwCompareDateValue = new Date(wrtCalendarLayDate.getFullYear(),wrtCalendarLayDate.getMonth(),wrtCalendarLayDate.getDate()).valueOf();
                            }
                        }
                    }
                }
            ...
            "<tr class='scwHead' >" +
                 "<td class='scwHead'>" +
                    "<input class='scwHead' id='scwHeadLeft' type='button' value='<' " +
                            "onclick='wrtCalendarLayMonth(-1);'  /></td>" +
                 "<td class='scwHead'>" +
                    "<select id='scwYears' class='scwHead' " +
                            "onchange='wrtCalendarLayMonth(0);'>" +
                    "</select>" +
                 "</td>" +
                 "<td class='scwHead'>" +
